				...
				<div class="tab-pane fade in active" id="settings">
					<!-- Profile info -->						
						<div class="panel-body">
							<form action="{{ route('provider.updateProfile') }}" method="post">
							    @csrf
	...
	<div class="col-lg-3">
		...
		<div class="thumbnail">
			<div class="thumb thumb-rounded thumb-slide">
				...
				<div class="caption">
					<span>
						<a href="{{route('provider.userImage')}}" class="btn bg-success-400 btn-icon btn-xs" data-popup="lightbox"><i class="icon-plus2"></i>Change</a>
					</span>
				</div>
			</div>
